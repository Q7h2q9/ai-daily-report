...
_TEST_SITE_URL = "https://example.github.io/test-repo/"
_TEST_RAW_URL = "https://github.com/example/test-repo/blob/main/data/reports/latest-summary.md"
...
def test_render_text_notification_uses_executive_brief_short_shape():
    text = render_text_notification(
        ...
        public_site_url=_TEST_SITE_URL,
        raw_report_url=_TEST_RAW_URL,
    )
